...
\author{Gohil Dwijesh \\ 2017CS50407
        \and Prafful Ravuri \\ 2017CS10369}
\date{August 2019}
...
\section{Local network analysis}
    ...
    \end{table}
    \begin {itemize}
    \item \textbf{NOTE:} Here, while probing into sub networks, we used 24 as the network prefix length and we couldn't find any transitory devices. Even at 22 it remained the same.
    \end {itemize}
%-----------------------------------------------------------------------
    ...
    \begin{table}[ht]
        ...
        \resizebox{\textwidth}{!}{%
            \begin{tabular}{|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
                ...
                \hline
                s1(Czech) & 17 & 123.7 & 18 & 200.9 & - & - & 6 & 6.5 & 6 & 5.73\\
                \hline
                s2(USA)  & 13 & 20.4 & 15 & 217.4 & - & - & 7 & 3.0 & 8 & 18.7\\
                \hline
                s3(Australia) & 17 & 208.5 & 21 & 417.3 & - & - & 14 & 208.1 & 11 & 189.1\\
                \hline
            \end{tabular}{}
        }
    ...
    \begin{table}[!h]
        ...
        \resizebox{\textwidth}{!}{%
            \begin{tabular}{|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
                ...
                \hline
                Total path & 14 & 476 & 17 & 682.5 & - & - & 10 & 78.4 & 9 & 52.2\\
                \hline
                last router in local ISP & 6 & 560.7 & 6 & 223.8 & 6 & 34.7 & 5 & 38.3 & 6 & 54.4\\
                \hline
